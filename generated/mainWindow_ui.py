...
class Ui_BrewMaster(object):
    def setupUi(self, BrewMaster):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 160, 1061, 731))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(1080, 160, 231, 601))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.avgTemp.sizePolicy().hasHeightForWidth())
        self.avgTemp.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.maxpH.sizePolicy().hasHeightForWidth())
        self.maxpH.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.minpH.sizePolicy().hasHeightForWidth())
        self.minpH.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.avgpH.sizePolicy().hasHeightForWidth())
        self.avgpH.setSizePolicy(sizePolicy)
